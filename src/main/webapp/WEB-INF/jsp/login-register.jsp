...
<body>
    ...
    <div id="page">
        ...
        <div class="page-inner">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="${pageContext.request.contextPath}/">人在旅途 <em>.</em></a></div>
                        </div>
                        <div class="col-xs-8 text-right menu-1">
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/tavelNotesView">游记</a></li>
                                <li><a href="${pageContext.request.contextPath}/placesView">火车票</a></li>
                                <li><a href="${pageContext.request.contextPath}/contactView">联系</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(images/destination-1.jpg)">
                                    ...
                                    <div class="form-wrap">
                                        <div class="tab">
                                            <ul class="tab-menu">
                                                ...
                                                <li class="active gtco-second"><a href="#" data-tab="login">注册</a></li>
                                            </ul>
