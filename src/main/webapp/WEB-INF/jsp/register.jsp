						...
						<div class="form-bottom">
							<form role="form"
								...
								<div class="form-group">
									<label for="form-first-name">手机号码</label> <input type="text"
										name="mobile" placeholder="手机号码" class="form-control"
										id="mobile">
								</div>
								<div class="form-group">
									<label for="form-last-name">密码</label> <input type="text"
								...
								<div class="form-group">
									...
									<div class="form-inline">
										<input type="text" name="code" placeholder="验证码"
											class="form-control size" id="SMS"> <input
											class="btn btn-default" type="button" value="发送验证码"
											onclick="sendcode()">
									</div>
								</div>
