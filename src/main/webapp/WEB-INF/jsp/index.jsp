			...
			<div class="row">
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="destination">
						<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(https://youimg1.c-ctrip.com/target/10030v000000jvhc39E1E.jpg);">
						...
						<div class="text p-3">
							...
							<p>造访宋、元、明、清四个朝代的古窑，解密景德镇陶瓷制作过程和历史，欣赏瓷乐演奏。</p>
							<p class="days">开放时间：8:00-17:00</p>
							<hr>
							<p class="bottom-area d-flex">
								<span><i class="icon-map-o"></i> 景德镇</span>
